...
export CATALINA_HOME=/home/d/tomcat

if echo $1 | grep -q "/home/d/www"
then
	export CATALINA_BASE=$1
else
	export CATALINA_BASE=/home/d/www/$1
fi

instance=`ls /home/d/www/ | head -1`;
if ! [ -e $CATALINA_BASE/conf/server.xml ]
then
	echo -e " usage: $0 home/d/www/$instance\n"
	exit 1;
fi
